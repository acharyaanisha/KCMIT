...
class FacultyNotices extends StatefulWidget {
  const FacultyNotices({super.key});

  @override
  State<FacultyNotices> createState() => _FacultyNoticesState();
}

class _FacultyNoticesState extends State<FacultyNotices> {
